    ...
    <form action="/product" method="post" enctype="multipart/form-data">
        ...
        <div class="row mt-3">
            <div class="col-md-4">
                ...
                <input type="number" class="form-control @error('purchase_price') is-invalid @enderror"
                    name="purchase_price" id="purchase_price" placeholder="Harga Beli" value="{{ old('purchase_price') }}"
                    onkeyup="findSellingPrice(this.value)">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price"
                    id="selling_price" placeholder="Harga Beli"value="{{ old('selling_price') }}" readonly>
                @error('selling_price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <img id="image-preview" class="img-fluid my-2" width="200" />
